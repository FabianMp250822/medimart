...
export const metadata: Metadata = {
    title: 'Ortopedia y Traumatología - Clínica de la Costa',
    description: 'Cuidado integral del sistema musculoesquelético. Tratamos lesiones deportivas, fracturas, y realizamos reemplazos articulares con tecnología avanzada.',
};
...
async function getSpecialists(): Promise<Medico[]> {
    try {
        ...
        console.error("Error fetching specialists for Ortopedia y Traumatología: ", error);
        return [];
    }
}
