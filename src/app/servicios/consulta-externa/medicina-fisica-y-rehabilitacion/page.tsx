    ...
    return (
        <div className="space-y-12">
            ...
            <div className="relative h-96 w-full rounded-lg overflow-hidden">
                <Image
                    src="https://firebasestorage.googleapis.com/v0/b/clinica-de-la-costa.appspot.com/o/web%20imagen%2Ftratamiento-rehabilitacion-fisica.jpg?alt=media"
                    alt="Terapias de Medicina Física y Rehabilitación"
                    layout="fill"
                    objectFit="cover"
                    className="rounded-lg"
                    data-ai-hint="physical therapy"
                />
            </div>
