      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground mb-6">
            Nuestra consulta externa ofrece acceso a una gran variedad de especialistas para el diagnóstico, tratamiento y seguimiento de diversas condiciones de salud. Brindamos una atención ambulatoria de alta calidad, centrada en las necesidades de cada paciente.
          </p>
