...
const category = servicesData.find(cat => cat.slug === 'otros-programas');
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground mb-6">
            Además de nuestras especialidades principales, ofrecemos programas especializados diseñados para atender condiciones complejas y proporcionar un cuidado integral y multidisciplinario a nuestros pacientes.
          </p>
