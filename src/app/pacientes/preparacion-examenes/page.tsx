...
export const metadata: Metadata = {
  ...
  description: 'Encuentre aquí las instrucciones detalladas para la preparación de exámenes como colonoscopia, ecocardiograma, tomografía, mamografía y más en la Clínica de la Costa.',
};
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Una preparación adecuada es fundamental para garantizar la calidad y precisión de sus resultados. A continuación, encontrará las guías de preparación para nuestros principales exámenes diagnósticos. Por favor, lea atentamente las instrucciones correspondientes al estudio que se va a realizar.
          </p>
        </CardContent>
      </Card>
