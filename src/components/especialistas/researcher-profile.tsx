...
export function ResearcherProfile({ data, specialistId }: ResearcherProfileProps) {
  ...
  const hardcodedData: { [key: string]: any } = {
    'p3DcIXWsU0fJ4m0uamrr': {
      previousPublications: [
          { "doi": "10.1038/s41598-024-70913-6", "editorial": "Nature Publishing Group", "fecha": "2024-08-15", "titulo_articulo": "Gene profiling of Epstein-Barr Virus and human endogenous retrovirus in peripheral blood mononuclear cells of SLE patients: immune response implications", "revista": "Scientific Reports" },
          { "doi": "10.1007/s11255-024-03949-2", "editorial": "Springer Netherlands", "fecha": "2024-03-11", "titulo_articulo": "Alactic base excess (ABE): a novel internal milieu parameter—its concept and clinical importance", "revista": "International Urology and Nephrology" },
          { "doi": "10.1016/j.xkme.2024.100845", "editorial": "Elsevier Inc.", "fecha": "2024-02-15", "titulo_articulo": "CKD Stage and Cardiovascular and Mortality Events Among Older Adults: The SPRINT Trial", "revista": "Kidney Medicine" },
          { "doi": "10.1177/2333794X241231133", "editorial": "Sage Publications Inc", "fecha": "2024-02-09", "titulo_articulo": "Atypical Hemolytic Uremic Syndrome: A Nationwide Colombian Pediatric Series", "revista": "Global Pediatric Health" },
          { "doi": "10.47307/GMC.2024.132.1.8", "editorial": "Academia Nacional De Medicina", "fecha": "2024-01-01", "titulo_articulo": "Caracterización clínica y epidemiológica de la enfermedad renal poliquística en un Centro de referencia de Cuarto Nivel del Caribe Colombiano (2008-2022)", "revista": "Gaceta Médica de Caracas" },
          { "doi": "10.4103/ijn.ijn_175_22", "editorial": "Wolters Kluwer Medknow Publications", "fecha": "2024-01-01", "titulo_articulo": "Mortality Rate and Acute Kidney Injury Prevalence Reduction in COVID-19 Critical Patients Treated with Hemoperfusion", "revista": "Indian Journal of Nephrology" },
          { "doi": "10.1038/s41598-024-53679-9", "editorial": "Nature Publishing Group", "fecha": "2024-02-01", "titulo_articulo": "Surface-enhanced Raman Spectroscopy in urinalysis of hypertension patients with kidney disease", "revista": "Scientific Reports" },
          { "doi": "10.3390/ijms24098290", "editorial": "MDPI", "fecha": "2023-05-05", "titulo_articulo": "From Cell to Symptoms: The Role of SARS-CoV-2 Cytopathic Effects in the Pathogenesis of COVID-19 and Long COVID", "revista": "International Journal of Molecular Sciences" },
          { "doi": "10.3389/fneph.2023.1133352", "editorial": "Frontiers", "fecha": "2023-08-23", "titulo_articulo": "Insulin and the kidneys: a contemporary view on the molecular basis", "revista": "Frontiers in Nephrology" },
          { "doi": "10.1055/a-2164-8438", "editorial": "Thieme Medical Publishers Inc.", "fecha": "2023-11-20", "titulo_articulo": "Pregnancy-Associated Atypical Hemolytic Uremic Syndrome: A Case Report with a rare MCP Gene Mutation and Successful Eculizumab Treatment", "revista": "AJP Reports" },
          { "doi": "10.1007/s11845-023-03490-8", "editorial": "Springer London", "fecha": "2023-09-18", "titulo_articulo": "Hyponatremia and malnutrition: a comprehensive review", "revista": "Irish Journal of Medical Science" },
          { "doi": "10.1016/j.semnephrol.2023.151336", "editorial": "W.B. Saunders Ltd", "fecha": "2023-03-01", "titulo_articulo": "Chronic Kidney Disease Burden in Low-Resource Settings: Regional Perspectives", "revista": "Seminars in Nephrology" },
          { "doi": "10.3390/biomedicines11092435", "editorial": "MDPI", "fecha": "2023-09-02", "titulo_articulo": "Handgrip Strength Is Associated with Specific Aspects of Vascular Function in Individuals with Metabolic Syndrome", "revista": "Biomedicines" }
      ],
      newPublications: [
    ...
    'eM8fDVBxZ7KebIU5vJVT': {
       newPublications: [
        { "titulo_articulo": "Histopathologic Patterns in Lupus Nephritis: A Case Series of Late-Onset Systemic Lupus Erythematosus", "fecha": "2025" },
        { "titulo_articulo": "Analysis of Memory Antibody Responses in Individuals with Zika-Associated Guillain–Barré Syndrome", "fecha": "2024" },
        { "titulo_articulo": "Treatment adherence and quality of life in colombian patients with lupus nephritis", "fecha": "2024" },
        { "titulo_articulo": "Gene profiling of Epstein-Barr Virus and human endogenous retrovirus in peripheral blood mononuclear cells of SLE patients: immune response implications", "fecha": "2024" },
        { "titulo_articulo": "Cardiovascular Risk in Chinese Immigrants in the Colombian Caribbean Region", "fecha": "2024" },
        { "titulo_articulo": "Differential Gene Profiling of Epstein-Barr Virus and Human Endogenous Retrovirus in Peripheral Blood Mononuclear Cells of Patients with Systemic Lupus Erythematosus", "fecha": "2024" },
        { "titulo_articulo": "POS0741 IMPACT OF ACTIVE LUPUS NEPHRITIS ON THE QUALITY OF LIFE OF PATIENTS FROM A LATIN AMERICAN LUPUS COHORT", "fecha": "2024" },
        { "titulo_articulo": "ARTÍCULO ESPECIAL Proyecto y Alianza Centenarios: Cohorte COOLCEN", "fecha": "2024" },
        { "titulo_articulo": "WCN24-1355 RISK OF DIALYSIS ACCORDING TO THE KIDNEY FAILURE RISK EQUATION (KFRE) IN PATIENTS WITH CHRONIC KIDNEY DISEASE ENROLLED IN A NEPHROPROTECTION PROGRAM IN LA GUAJIRA", "fecha": "2024" },
        { "titulo_articulo": "Cytokine and T cell responses in post-chikungunya viral arthritis: A cross-sectional study", "fecha": "2024" },
        { "titulo_articulo": "Delayed Diagnosis in Systemic Lupus Erythematosus", "fecha": "2024" },
        { "titulo_articulo": "Development of a Chikungunya Arthritis Disease Activity Score (CHIK-DAS) Based on a Prospective Cohort Study", "fecha": "2024" },
        { "titulo_articulo": "Hemorragias de vías digestivas altas asociada a helicobacter pylori en Barranquilla (Atl, Co) entre los años 2021 a 2023", "fecha": "2024" },
        { "titulo_articulo": "A descriptive analysis of risk factors for chronic kidney disease among the Afro-descendant population of San José de saco in the department of Atlántico, Colombia", "fecha": "2024" },
        { "titulo_articulo": "The Journal of Rheumatology 52 (Suppl 1), 14-15 - Delayed Diagnosis in Systemic Lupus Erythematosus", "fecha": "2025" },
        { "titulo_articulo": "The role of autoantibodies in post-chikungunya viral arthritis disease severity", "fecha": "2025" },
        { "titulo_articulo": "609 Pregnancy outcomes in systemic lupus erythematosus (SLE): data from a multiethnic, multinational Latin American cohort", "fecha": "2024" },
        { "titulo_articulo": "The natural history of post-chikungunya viral arthritis disease activity and T-cell immunology: a cohort study", "fecha": "2024" }
      ]
    }
  };
  ...
  const allPublications = [
    ...
    ...(specialistHardcodedData.previousPublications || []),
    ...(specialistHardcodedData.newPublications || [])
  ];
  ...
  const publicationByYear = uniquePublications.reduce((acc, pub) => {
    const yearString = String(pub.fecha || pub.Año).split('-')[0];
            ...
            <TabsContent value="publications" className="mt-6">
                ...
                <CardContent>
                    ...
                    {uniquePublications.sort((a,b) => {
                        const yearA = a.fecha ? String(a.fecha).split('-')[0] : String(a.Año);
                        const yearB = b.fecha ? String(b.fecha).split('-')[0] : String(b.Año);
                        const dateA = new Date(yearA).getTime();
                        const dateB = new Date(yearB).getTime();
                        return dateB - dateA;
                    }).map((pub, index) => (
                        <li key={index} className="border-b pb-4 last:border-b-0 last:pb-0">
                        <p className="font-bold text-foreground">{pub.titulo_articulo || pub.Título}</p>
                        <p className="text-sm text-muted-foreground">{pub.revista} ({String(pub.fecha || pub.Año).split('-')[0]})</p>
