                        ...
                        <div className="row">
                            ...
                            <div className="col-12 col-md-9">
                                <div className="pt-4">
                                    ...
                                    <div className="mb-4">
                                        <img
                                            src="https://picsum.photos/1200/400?random=21"
                                            alt="Cirugía Cardiovascular"
                                            style={{
                                                width: '100%',
                                                borderRadius: '8px',
                                    ...
                                    <div id="accordion" className="accordion">
                                        ...
                                        <div className="accordion-item">
                                            ...
                                            {isActive === 5 && (
                                                <div className="accordion-body">
                                                    <ul className="service-list">
                                                        <li>Sistemas de imagen avanzados: Para diagnosticar y planificar procedimientos con precisión.</li>
                                                        <li>Monitoreo intraoperatorio de alta tecnología: Que asegura un control constante durante las cirugías.</li>
                                                        <li>Laboratorio de cateterismo cardíaco: Para procedimientos diagnósticos y terapéuticos en tiempo real.</li>
                                                    </ul>
                                                </div>
                                            )}
                                        </div>
                                        ...
                                        <div className="accordion-item">
                                            <h2
                                                ...
                                                style={{
                                                    cursor: 'pointer',
                                                    backgroundColor: isActive === 6 ? '#1A1A3B' : '#f9f9f9',
                                                    color: isActive === 6 ? '#fff' : '#1A1A3B',
                                                    padding: '10px 15px',
                                                    borderRadius: '5px',
                                                    marginBottom: '5px',
                                                    fontSize: '18px',
